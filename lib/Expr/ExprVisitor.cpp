...
//  if (e.get()->getKind() == Expr::Str_Itoa)        return e;
    ...
    case Expr::Str_Prefix:     res = visitPrefixStringsExpr(static_cast<StrPrefixExpr&>(ep)); break;
...
ExprVisitor::Action ExprVisitor::visitPrefixStringsExpr(const StrPrefixExpr&) { return Action::doChildren();}
